...
# Save to CSV
patients_df.to_csv("data//Patients_with_noise.csv", index=False, na_rep='NULL')
doctors_df.to_csv("data//Doctors_with_noise.csv", index=False, na_rep='NULL')
appointments_df.to_csv("data//Appointments_with_noise.csv", index=False, na_rep='NULL')
diagnoses_df.to_csv("data//Diagnoses_with_noise.csv", index=False, na_rep='NULL')
prescriptions_df.to_csv("data//Prescriptions_with_noise.csv", index=False, na_rep='NULL')
billing_df.to_csv("data//Billing_with_noise.csv", index=False, na_rep='NULL')
